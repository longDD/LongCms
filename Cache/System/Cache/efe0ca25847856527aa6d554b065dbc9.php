...
<div>
    <div class="Item hr">
        ...
        <div id='inside_menu'>
            <ul>
                <li><a id='add_user_btn' href='javascript:;'>添加管理员</a></li>
            </ul>
        </div>
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab" id="user_table">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
                ...
                <td><?php if($vo['status']): ?><font style='color:green;'>可用</font><?php else: ?><font style='color:red;'>禁用</font><?php endif; ?></td>
    ...
    <div id='Add_user' style='display: none;'>
        <form id='Add_user_form' action="" method="post">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                ...
                <tr>
                    <th>重复密码：</th>
                    <td><input class="input" name="pwd_r" type="password" size="40" value="" /></td>
                </tr>
                <tr>
                    <th>邮箱：</th>
                    <td><input class="input" name="email" type="text" size="40" value="" /></td>
                </tr>
                <tr>
                    <th>状态：</th>
                    <td>
